            ...
            <React.Fragment className="conte">
                <div className="card-deck conte">
                    <div class="card">
                        ...
                        <p class="card-text text_1">Atrévete, conoce y aprende sobre cómo han influido la politica y la democracia a lo largo de cada etapa de tu vida</p>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <p class="card-text text_1">¿Te gustaría saber que hitos e historias han marcado a Colombia con respecto a su pensamiento político y democratico?</p>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <p class="card-text text_1">Es importante conocer las razones por las cuales debemos ejercer el voto, al igual que informarnos cómo y dónde hacerlo</p>
                        </div>
                    </div>
                </div>
