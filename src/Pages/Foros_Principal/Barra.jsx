...
import '../Foros_Principal/estilo5.css';
                ...
                <nav className="barrita navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="elements__down dropdown-item" href="#">¿Por qué hacerlo?</a>
                            <a class="elements__down dropdown-item" href="#">¿Dónde debo hacerlo?</a>
                            <a class="elements__down dropdown-item" href="#">¿Cómo hacerlo de manera correcta?</a>
                            </div>
                        </li>
                        <li class="nav-item">
